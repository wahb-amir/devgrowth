  ...
  const saved = await ScoredSnapshotModel.create({
    ...
    subScores: {
      activity: {
        ...
        weightedScore:
          result.subScores.activity * result.layers.l5.weights.activity,
        signals: [],
      ...
      impact: {
        ...
        weightedScore:
          result.subScores.impact * result.layers.l5.weights.impact,
        signals: [],
        tags: ["impact"],
      },
      quality: {
        ...
        weightedScore:
          result.subScores.quality * result.layers.l5.weights.quality,
        signals: [],
      ...
      consistency: {
        ...
        weightedScore:
          result.subScores.consistency * result.layers.l5.weights.consistency,
        signals: [],
        tags: ["consistency"],
      },
      reach: {
